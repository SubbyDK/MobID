...
It will make creating certain addons a bit easier to make.  
...
## How does it work?
It collects the mob name, mob level, and the zone you are in.  
Then I find the ID for that specific mob on the Turtle WoW database and enter it into the project database.
